...
INSERT INTO "new_Guest" ("code", "createdAt", "diet", "id", "invitedById", "maxInvites", "name", "plusOneAllowed", "plusOneDiet", "plusOneName", "role", "rsvpAfterParty", "rsvpDinner", "rsvpMain", "songRequest", "updatedAt") SELECT "code", "createdAt", "diet", "id", "invitedById", "maxInvites", "name", "plusOneAllowed", "plusOneDiet", "plusOneName", "role", "rsvpAfterParty", "rsvpDinner", "rsvpMain", "songRequest", "updatedAt" FROM "Guest";
DROP TABLE "Guest";
